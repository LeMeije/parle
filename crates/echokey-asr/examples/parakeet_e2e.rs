...
//! Run: cargo run --release --example parakeet_e2e -p echokey-asr --features "metal,parakeet"

#[cfg(feature = "parakeet")]
fn main() {
    use echokey_asr::parakeet::ParakeetEngine;
    use echokey_asr::{download, registry, AsrEngine, TranscribeOptions};
