...
fn a_one_megabyte_item_survives_the_round_trip() {
    ...
    let (code_a, code_b) = (code.clone(), code);
    let text = "ż".repeat(parle_sync::wire::MAX_ITEM_TEXT_BYTES / 2); // exactly 1 MiB
