//! Parle sync: the LAN-only, end-to-end encrypted replication protocol.
//!
...
//! | [`discovery`] | advertise and browse `_parle._tcp` over mDNS |
...
//!
//! ```no_run
//! use parle_sync::identity::DeviceId;
//! use parle_sync::pairing::{Pairing, PairingCode, PairingRole};
//! use parle_sync::session::Session;
//! use parle_sync::wire::SyncMessage;
...
//! # let peer_tag = parle_sync::pairing::ConfirmTag::from_bytes([0u8; 32]);
