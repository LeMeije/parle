...
pub const IDENTITY_INITIATOR: &[u8] = b"parle-sync/1/pairing/initiator";
/// SPAKE2 identity for the side that types the code in.
pub const IDENTITY_RESPONDER: &[u8] = b"parle-sync/1/pairing/responder";

const TRANSCRIPT_LABEL: &[u8] = b"parle-sync/1/pairing/transcript";
const LABEL_LONG_TERM_KEY: &[u8] = b"parle-sync/1/pairing/long-term-key";
const LABEL_CONFIRM_INITIATOR: &[u8] = b"parle-sync/1/pairing/confirm/initiator";
const LABEL_CONFIRM_RESPONDER: &[u8] = b"parle-sync/1/pairing/confirm/responder";
